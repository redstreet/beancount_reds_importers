...
fund_data = [
    ...
    # todo test a bond where chosen symbol fails on substring match
    (
        "CUSIP412003AD7",
        # "CUSIP03AD7",
        "412003AD7",
    ...
    # todo test mapping a security to different symbol
    # ("V-V", "92826C839", "VISA INC"),
    # todo test a security with a symbol as a substring
