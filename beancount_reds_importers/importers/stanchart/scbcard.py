...
class Importer(csvreader.Importer, banking.Importer):
    ...
    def prepare_table(self, rdr):
        ...
        # Uncomment to include currency conversions. This won't work as expected since Beancount v2
        # doesn't support adding @@ (total price conversions) via code. See https://groups.google.com/g/beancount/c/nMvuoR4yOmM
